...
const PrivacyPolicy = () => {
  return (
    <div className='container'>
      ...
      <h3>Publicidad</h3>
      <p>Dentro de la aplicación encontrarás anuncios proporcionados por AdMob. Es un servicio de publicidad proporcionado por Google que puede recopilar y utilizar datos anónimos para personalizar los anuncios para el usuario.
